...
//        public double[,] LinearFlows { get; private set; }
...
//            LinearFlows = new double[_mN, _mN];
...
//                    LinearFlows[i, j] = _mVariables[i, j].Get(GRB.DoubleAttr.X);
//                }
//            }
...
//                for (int j = 0; j < _mN; j++)
//                {
//                    NodeOptimum[i] = NodeOptimum[i] - LinearFlows[i, j] + LinearFlows[j, i];
//                }
//            }
//        }
