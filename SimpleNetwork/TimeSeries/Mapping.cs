...
namespace BusinessLogic.TimeSeries
{
    public static class Mapping
    {
        ...
        /// </summary>
        /// <param name="tsValues"> the time series values </param>
        /// <param name="binCount"> the (optionary) bin count </param>
        /// <returns> a data bin table </returns>
        public static DataBinTable ToDataBinTable(this List<double> tsValues, int binCount = 16)
        {
            double[] midPoints;
            double[] values;
        ...
        {
            return input.GetAllValues().ToDataBinTable(binCount);
        }
        ...
        {
            return input.GetAllValues().ToDataBinTable(midPoints);
        }
        ...
        /// <param name="midPoints"> the bin midPoints (assumed to be ordered and equally spaced) </param>
        /// <returns> a data bin table </returns>
        public static DataBinTable ToDataBinTable(this List<double> tsValues, double[] midPoints)
        {
