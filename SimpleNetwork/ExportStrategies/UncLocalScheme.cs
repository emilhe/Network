...
namespace BusinessLogic.ExportStrategies
{
    class UncLocalScheme : IExportScheme
    {
        ...
        private readonly QuadraticOptimizer _mOptimizer;
        ...
        public UncLocalScheme(IList<INode> nodes, EdgeCollection edges)
        {
            ...
            _mOptimizer = new QuadraticOptimizer(nodes.Count, 0); // HERE NO STORAGE IS ASSUMED!!
            _mOptimizer.SetEdges(_mEdges);
        }
