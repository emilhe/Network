...
namespace UnitTest
{
    ...
    class MismatchOptimizerTest
    {
        ...
        public void TwoNodeTest()
        {
            ...
            var optimum = opt.Solve();
            AreAlmostEqual(1, optimum, FlowDelta);
            ...
            optimum = opt.Solve();
            AreAlmostEqual(0, optimum, FlowDelta);
        ...
        public void FourNodeAllEdgeTest()
        {
            ...
            var optimum = opt.Solve();
            AreAlmostEqual(2, optimum, FlowDelta * edges.NodeCount);
            var flowSum = 0.0;
        ...
        public void ChargeLimitTest()
        {
            ...
            var optimum = opt.Solve();
            AreAlmostEqual(0, optimum, FlowDelta * edges.NodeCount);
            AreAlmostEqual(new double[,] { { 0, 1 }, { -1, 0 } }, opt.Flows, FlowDelta);
            AreAlmostEqual(new double[] { 0, 0 }, opt.NodeOptimum, FlowDelta * edges.NodeCount);
        }
