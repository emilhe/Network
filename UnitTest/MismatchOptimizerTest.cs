...
//            AreAlmostEqual(new double[,] { { 0,1 }, { 0, 0 } }, opt.LinearFlows, FlowDelta);
...
//            AreAlmostEqual(new double[,] { { 0, 2 }, { 0, 0 } }, opt.LinearFlows, FlowDelta);
...
//            var flowSum = 0.0;
//            foreach (var flow in opt.LinearFlows) flowSum += flow*flow;
//            AreAlmostEqual(4.5, flowSum, FlowDelta * edges.NodeCount);
//            AreAlmostEqual(new double[] { 0, 0, 2, 0 }, opt.NodeOptima, FlowDelta * edges.NodeCount);
//        }
...
//            AreAlmostEqual(2, opt.OptimalBalance, FlowDelta * edges.NodeCount);
//            var flowSum = 0.0;
//            foreach (var flow in opt.LinearFlows) flowSum += Math.Abs(flow);
//            AreAlmostEqual(4, flowSum, FlowDelta * edges.NodeCount);
//            AreAlmostEqual(new double[] { 1, 0, 1, 0 }, opt.NodeOptima, FlowDelta * edges.NodeCount);
//        }
...
//            opt.Solve();
//            AreAlmostEqual(0, opt.OptimalBalance, FlowDelta * edges.NodeCount);
//            AreAlmostEqual(new double[,] { { 0, 3 }, { 0, 0 } }, opt.LinearFlows, FlowDelta * edges.NodeCount);
//            AreAlmostEqual(new double[] { 0, 0 }, opt.NodeOptima, FlowDelta * edges.NodeCount);
//        }
